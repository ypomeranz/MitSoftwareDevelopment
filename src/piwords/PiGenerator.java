...
public static int[] computePiInHex(int precision) {
    ...
    public static int powerMod(int a, int b, int m) {
        ...
        java.math.BigInteger k = java.math.BigInteger.valueOf(a).pow(b);
        java.math.BigInteger result = k.mod(java.math.BigInteger.valueOf(m));
            if (result.compareTo(java.math.BigInteger.valueOf(2).pow(31)) == 1){
                throw new ArithmeticException();
            }
        return k.mod(java.math.BigInteger.valueOf(m)).intValue();
    }
